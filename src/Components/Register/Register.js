...
import signimg from '../../img/regimg.jpg';
            ...
            <div className="mainrowsec1 row">
                <div className="col md-6 col-lg-6 col-sm-12 col-xs-12">
                    ...
                    <form className="regform-box">
                        <div className="input-icons" onSubmit={handleSubmit}>
                        ...
                        <div style={{display:'flex'}}><Link to="/Login"><button type="submit" className="login">Back To Login</button></Link>
